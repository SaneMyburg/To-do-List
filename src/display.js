import { arrayOfObjects, showToDo } from './index.js'; // eslint-disable-line import/no-cycle

export const createTask = (todo, id) => { // eslint-disable-line import/prefer-default-export
